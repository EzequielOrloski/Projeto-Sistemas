...
export const locate  = (beacons, b, px_meter) => {
    ...
    let input = [
        [ parseInt(b[0].x, 10), parseInt(b[0].y, 10), calculateDistance(beacons.b[0].r)],
        [ parseInt(b[1].x, 10), parseInt(b[1].y, 10), calculateDistance(beacons.b[1].r)],
        [ parseInt(b[2].x, 10), parseInt(b[2].y, 10), calculateDistance(beacons.b[2].r)]
    ];
